defmodule TimeManagerWeb.WidgetUserControllerTest do
  ...
  describe "create widget_user" do
    test "renders widget_user when data is valid", %{conn: conn} do
      conn = post(conn, Routes.widget_user_path(conn, :create), widget_user: @create_attrs)
    ...
    test "renders errors when data is invalid", %{conn: conn} do
      conn = post(conn, Routes.widget_user_path(conn, :create), widget_user: @invalid_attrs)
  ...
  describe "update widget_user" do
    ...
    test "renders widget_user when data is valid", %{conn: conn, widget_user: %WidgetUser{id: id} = widget_user} do
      conn = put(conn, Routes.widget_user_path(conn, :update, widget_user), widget_user: @update_attrs)
